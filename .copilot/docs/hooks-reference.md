...
Hooks are configured in `.copilot/settings.json` and fire automatically:
...
Hook reference documentation: `.copilot/docs/hooks-reference/`
Hook input schema documentation: `.copilot/docs/hooks-reference/hook-input-schemas.md`
