...
1. Copy this template to your project root: `cp .copilot/docs/COPILOT-local-template.md COPILOT.local.md`
2. Edit to match your preferences
3. Verify `COPILOT.local.md` is in `.gitignore` (GitHub Copilot reads it from the project root)
