...
- [Context 1 鈥?why this problem needed solving]
- [Context 2 鈥?constraints at the time]
- [Context 3 鈥?alternatives that were likely considered]
...
- [Reason 1 鈥?why this approach was chosen]
- [Reason 2 鈥?what problem it solves]
- [Reason 3 鈥?what benefit it provides]
...
**Why Not Chosen**: [Reason 鈥?from user clarification or inference]
...
鉁?**[Benefit 1]**: [How the implementation provides this]
...
鈿狅笍 **[Trade-off 1]**: [What was sacrificed or made harder]

鈿狅笍 **[Trade-off 2]**: [Limitation or cost]

鈿狅笍 **[Trade-off 3]**: [Complexity or maintenance burden]

### Neutral Consequences (Observations)

鈩癸笍 **[Observation 1]**: [Emergent property or side effect]

鈩癸笍 **[Observation 2]**: [Unexpected outcome]
...
**Thread Safety**:
- [Thread safety approach 鈥?single-threaded, mutex-protected, lock-free, etc.]

**Testing Strategy**:
- [How this is tested 鈥?unit tests, integration tests, etc.]
...
- 鉁?[Evidence 1 鈥?e.g., "6 months in production without issues"]
- 鉁?[Evidence 2 鈥?e.g., "handles 10k entities at 60 FPS"]
- 鈿狅笍 [Evidence 3 鈥?e.g., "works but needs monitoring"]

**Known Issues** (discovered during analysis):
- 鈿狅笍 [Issue 1]: [Problem and potential fix]
- 鈿狅笍 [Issue 2]: [Problem and potential fix]
...
**Immediate**:
- [ ] [Task 1 鈥?e.g., "Add missing unit tests"]
- [ ] [Task 2 鈥?e.g., "Document edge case handling"]

**Short-Term**:
- [ ] [Task 3 鈥?e.g., "Refactor X for clarity"]
- [ ] [Task 4 鈥?e.g., "Add performance monitoring"]

**Long-Term**:
- [ ] [Task 5 鈥?e.g., "Revisit decision when Y is available"]
