...
The core fantasy is the emotional promise. It's not a feature list 鈥?it's the
...
1. [Mechanic 1 鈥?e.g., "Real-time combat with stamina management"]
2. [Mechanic 2 鈥?e.g., "Procedurally generated dungeons with hand-crafted rooms"]
3. [Mechanic 3 鈥?e.g., "Crafting system with discoverable recipes"]
...
- [ ] **Achievers** (goal completion, collection, progression) 鈥?How: [...]
- [ ] **Explorers** (discovery, understanding systems, finding secrets) 鈥?How: [...]
- [ ] **Socializers** (relationships, cooperation, community) 鈥?How: [...]
- [ ] **Killers/Competitors** (domination, PvP, leaderboards) 鈥?How: [...]
...
action. This MUST be intrinsically satisfying 鈥?if the 30-second loop isn't
...
Anti-pillars are equally important 鈥?they prevent scope creep and keep the
...
| ---- | ---- |
| **Recommended Engine** | [Godot / Unity / Unreal and why 鈥?consider scope, team expertise, platform targets] |
...
- [Risk 1 鈥?e.g., "Core loop may not sustain sessions > 30 minutes"]
- [Risk 2 鈥?e.g., "Player motivation unclear after main story ends"]

### Technical Risks
[Things that could be hard or impossible to build]
- [Risk 1 鈥?e.g., "Procedural generation quality is unproven"]
- [Risk 2 鈥?e.g., "Networking for 100+ players may require dedicated infrastructure"]

### Market Risks
[Things that could prevent commercial success]
- [Risk 1 鈥?e.g., "Genre is saturated with established competitors"]
- [Risk 2 鈥?e.g., "Target audience may be too niche for financial sustainability"]

### Scope Risks
[Things that could blow the timeline]
- [Risk 1 鈥?e.g., "Content volume exceeds team capacity"]
- [Risk 2 鈥?e.g., "Feature X depends on technology we haven't prototyped"]

### Open Questions
[Things that need prototyping or research before we can answer]
- [Question 1 鈥?and how we plan to answer it]
- [Question 2 鈥?and what prototype would resolve it]
...
**Required for MVP**:
1. [Essential feature 1 鈥?directly tests the hypothesis]
...
- [ ] Decompose concept into systems (`/map-systems` 鈥?maps dependencies, assigns priorities, guides per-system GDD writing)
