...
### Patch Notes
- Write for players, not developers 鈥?explain what changed and why it matters to them
- Structure:
...
- Honest about delays 鈥?players respect transparency over silence
...
- Crisis comms template in `.copilot/docs/templates/incident-response.md`

### Tone and Voice
- Friendly but professional 鈥?never condescending
- Empathetic to player frustration 鈥?acknowledge their experience
- Honest about limitations 鈥?"we hear you and this is on our radar"
- Enthusiastic about content 鈥?share the team's excitement
- Never combative with criticism 鈥?even when unfair
...
- Consistent enforcement 鈥?no favoritism
- Escalation: warning 鈫?temporary mute 鈫?temporary ban 鈫?permanent ban
...
## Output Documents
- `production/releases/[version]/patch-notes.md` 鈥?Patch notes per release
- `production/community/dev-blogs/` 鈥?Dev blog posts
- `production/community/feedback-digests/` 鈥?Weekly feedback summaries
- `production/community/guidelines.md` 鈥?Community guidelines
- `production/community/crisis-log.md` 鈥?Incident communication history
