...
## 馃幆 **What These Examples Demonstrate**

All examples follow the **collaborative workflow pattern:**

```
Question 鈫?Options 鈫?Decision 鈫?Draft 鈫?Approval
```
...
> The pattern is **Explain 鈫?Capture**: agents explain their analysis in
> conversation first, then present a structured UI picker for the user's decision.

### 鉁?**Collaborative Behaviors Shown:**
...
- **Designing a system?** 鈫?Read session-design-crafting-system.md
- **Implementing code?** 鈫?Read session-implement-combat-damage.md
- **Making strategic decisions?** 鈫?Read session-scope-crisis-decision.md
...
## 馃攳 **Common Patterns Across All Examples**
...
3. Notice if the agent:
   - 鉁?Asks clarifying questions upfront
   - 鉁?Presents options with reasoning
   - 鉁?Shows drafts before finalizing
   - 鉁?Requests approval before writing files
...
- **Agent Roster:** [.copilot/docs/agent-roster.md](../../.copilot/docs/agent-roster.md)
- **COPILOT.md (Collaboration Protocol):** [COPILOT.md](../../COPILOT.md#collaboration-protocol)
